...
BOT_TOKEN = environ.get("BOT_TOKEN", "7668383218:AAEcv8G-D9RoPvP65_Rbdm0Q1-A-S4rAD2Y")
...
BOT_USERNAME = environ.get("BOT_USERNAME", "UR_Yorha_Bot") # without @
...
CLONE_DB_URI = environ.get("CLONE_DB_URI", "mongodb+srv://smkbotz:aUqhVqEYsJfUQT58@cluster0.g9pmv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
CDB_NAME = environ.get("CDB_NAME", "Cluster0")

# Database Information
DB_URI = environ.get("DB_URI", "mongodb+srv://smkbotz:69ufNrjYoMhDDMUL@cluster0.1fw9s.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
